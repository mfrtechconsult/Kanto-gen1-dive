...
DIVE keeps its existing in-game presentation unchanged. The Wilds compatibility branch adds two new field examples specifically for the Crystal mechanics. A one-time hint appears when entering each showcase route for the first time on a save.
