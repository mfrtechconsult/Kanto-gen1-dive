...
-- Decorative blocks are intentionally all-water blocks: visual identity must
-- never turn an atlas water cell into an accidental collision wall.
return {
  default = "coastal",

  profiles = {
    coastal = {
      spaceScale = 2, music = "Music_Dungeon2", ecology = "ocean",
      decor = { 0, 0, 1, 3, 4, 5, 8, 11, 12, 13 },
      deepDecor = { 0, 1, 3, 5, 8, 11, 13, 14 }, encounterRate = 16,
    },
    ocean = {
      spaceScale = 3, music = "Music_Dungeon2", ecology = "ocean",
      decor = { 0, 0, 0, 1, 3, 4, 5, 8, 11, 12, 13, 14 },
      deepDecor = { 0, 0, 1, 5, 8, 11, 13, 14 }, encounterRate = 14,
    },
    harbor = {
      spaceScale = 2, music = "Music_Dungeon2", ecology = "harbor",
      decor = { 0, 1, 3, 4, 5, 8, 9, 11, 12 },
      deepDecor = { 0, 1, 5, 8, 9, 11, 12 }, encounterRate = 15,
    },
    volcanic = {
      spaceScale = 3, music = "Music_Dungeon2", ecology = "volcanic",
      decor = { 0, 5, 8, 9, 11, 13, 14 },
      deepDecor = { 0, 5, 8, 9, 11, 14 }, encounterRate = 14,
    },
    cave = {
      spaceScale = 2, music = "Music_Dungeon3", ecology = "cave",
      decor = { 0, 5, 8, 9, 11, 13, 14 },
      deepDecor = { 0, 5, 8, 9, 11, 14 }, encounterRate = 15,
    },
    freshwater = {
      spaceScale = 1, music = "Music_Dungeon2", ecology = "freshwater",
      decor = { 0, 0, 1, 3, 4, 5, 8, 11, 12 },
      deepDecor = { 0, 1, 3, 5, 8, 11, 12 }, encounterRate = 18,
    },
    marsh = {
      spaceScale = 1, music = "Music_Dungeon2", ecology = "marsh",
      decor = { 0, 1, 3, 4, 5, 8, 11, 12, 13 },
      deepDecor = { 0, 1, 5, 8, 11, 12, 13 }, encounterRate = 18,
    },
  },

  overrides = {
    PALLET_TOWN = "coastal",
    VIRIDIAN_CITY = "freshwater", PEWTER_CITY = "freshwater",
    CERULEAN_CITY = "freshwater", CELADON_CITY = "freshwater",
    SAFFRON_CITY = "freshwater", LAVENDER_TOWN = "freshwater",
    FUCHSIA_CITY = "marsh", VERMILION_CITY = "harbor",
    VERMILION_DOCK = "harbor", CINNABAR_ISLAND = "volcanic",
